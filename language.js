(() => {
  ...
  const messages = {
    de: {
      ...
      privacyIntro: "Verantwortlich für diese Website ist Robin James Lewis; Name und E-Mail-Adresse stehen oben. Die Website verwendet keine eigene Besuchermessung und keine Werbetracker. Schriften und Bilder werden zusammen mit der Website bereitgestellt.",
    ...
    en: {
      ...
      privacyIntro: "Robin James Lewis is responsible for this website; name and email address appear above. The website uses no visitor analytics of its own or advertising trackers. Fonts and images are served together with the website.",
